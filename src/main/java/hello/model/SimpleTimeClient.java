...
public record SimpleTimeClient(LocalDateTime dateAndTime) implements TimeClient {
    ...
    public void setTime(int hour, int minute, int second) {
        ...
        new SimpleTimeClient(LocalDateTime.of(currentDate, timeToSet));
    }
    ...
    public void setDate(int day, int month, int year) {
        ...
        new SimpleTimeClient(LocalDateTime.of(dateToSet, currentTime));
    }
    ...
    public void setDateAndTime(int day, int month, int year, int hour, int minute, int second) {
        var dateToSet = LocalDate.of(year, month, day);
        var timeToSet = LocalTime.of(hour, minute, second);
        new SimpleTimeClient(LocalDateTime.of(dateToSet, timeToSet));
    }
