Here is the refactored Java code in compliance with Java 20 standards:
...
This refactored code adheres to Java 20 standards and maintains the original functionality of the provided `SimpleTimeClient` class.